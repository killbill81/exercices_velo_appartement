...
import { Trophy, Download, X, Flame, Zap, Heart, RotateCw, Route, Clock, Activity } from 'lucide-react';
import { CompletedSession } from '../../types/user';
...
export const SessionSummaryModal: React.FC<SessionSummaryModalProps> = ({
  ...
  const powerZones = calculatePowerZones(userFtpWatts);
